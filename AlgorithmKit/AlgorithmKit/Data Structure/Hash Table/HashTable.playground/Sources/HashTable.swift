...
public struct HashTable<Key: Hashable, Value>: CustomStringConvertible {
    ...
    /// represents the contents of the hash table.
    ...
    /// represents the contents of the hash table, suitable for debugging
    ...
    /// Accesses the value associated with the fivenkey for reading and writing
    ...
    /// Update the value strored in the hash table for the fiven key,
    ...
    @discardableResult public mutating func updateValue(_ value: Value, forKey key: Key) -> Value? {
        ...
        /// This key isn't in the buket yet; add it to the chain.
